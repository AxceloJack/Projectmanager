  ...
  if (loading) {
    return (
      <div className="neu-surface flex-1 flex items-center justify-center">
        <p className="text-[#626875]">Loading clients…</p>
      </div>
    );
  }
    ...
    <div className="neu-surface flex-1 flex flex-col">
      ...
      <div className="border-b border-[#eceef2] px-8 py-6">
        <div className="flex justify-between items-start">
          <div>
            <h1 className="text-2xl font-bold text-[#17181c]">Clients</h1>
            <p className="text-[#626875] text-sm mt-1">Manage all your client projects and workflows</p>
          </div>
          <button
            onClick={() => {
              setSelectedClientForEdit(null);
      ...
      <div className="flex-1 overflow-auto p-8">
        {clients.length === 0 ? (
          <div className="flex flex-col items-center justify-center h-full text-center">
            ...
            <h3 className="text-xl font-bold text-[#17181c] mb-2">No clients yet</h3>
            <p className="text-[#626875] mb-6">Create your first client to get started</p>
            <button
                ...
                <div className="flex items-start justify-between gap-4">
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-3 mb-2 flex-wrap">
                      <h3 className="text-lg font-bold text-[#17181c]">{client.name}</h3>
                    ...
                    <div className="text-sm text-[#626875] space-y-1">
                      {client.kickOffDate && (
                  ...
                  <div className="flex gap-2 opacity-0 group-hover:opacity-100 transition-opacity flex-shrink-0 flex-wrap">
                    <button
                      ...
                      className="neu-pressable px-4 py-2 text-[#17181c] text-xs sm:text-sm font-semibold rounded-xl whitespace-nowrap"
                    >
                      Edit
                    </button>
                    <button
